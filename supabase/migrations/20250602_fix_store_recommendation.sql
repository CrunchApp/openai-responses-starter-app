-- Migration: Fix store_recommendation to insert recommendations correctly
-- Date: 2025-06-02

BEGIN;

-- Recreate store_recommendation with proper recommendation insertion
...
BEGIN
  ...
  -- Insert new recommendation linking to program
