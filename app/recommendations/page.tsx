...
export default function RecommendationsPage() {
      ...
      if (vectorStore && vectorStore.id) {
        try {
          ...
          if (result.error) {
            ...
            // Extract basic user profile from the first recommendation for personalization
            // In a real app, we'd fetch this separately
            if (result.recommendations[0]) {
              const firstRec = result.recommendations[0];
              setUserProfile({
                firstName: "Sarah", // This would come from user profile
                lastName: "Johnson",
                ...
                careerGoals: {
                  shortTerm: "Gain advanced knowledge in data science",
                  longTerm: "Become a senior data scientist",
                ...
                preferences: {
                  preferredLocations: ["United States", "Canada", "Remote"],
                  studyMode: "Full-time",
                  startDate: "Fall 2024",
                  budgetRange: {
                    min: 20000,
          ...
          setErrorMessage("An error occurred while generating recommendations");
          // Fall back to simulated data for demo purposes
          setMockData();
        } finally {
          setIsLoading(false);
  ...
  // Function to set mock data for demo purposes
  const setMockData = () => {
